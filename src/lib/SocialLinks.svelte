<script>
  let { iconsOnly = false } = $props();
</script>

<div class="social-links" class:icons-only={iconsOnly}>
  <a
    class="social-link"
  ...
  >
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      <path
        d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.3a6.34 6.34 0 0010.86 4.43v-7.2a8.16 8.16 0 005.58 2.17V11.2a4.85 4.85 0 01-3.77-1.51 4.83 4.83 0 003.77-3z"
      />
    </svg>
    {#if !iconsOnly}
      <span>TikTok</span>
